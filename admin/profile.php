<?php 
    ...
    if(isset($_SESSION['username'])) {
        ...
        $select_user_information = mysqli_query($connection, $query);
        confirm($select_user_information);
        while($row = mysqli_fetch_assoc($select_user_information)) {
            $user_id = $row['user_id'];
